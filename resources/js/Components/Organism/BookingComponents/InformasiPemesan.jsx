        ...
        <div className="w-full md:w-3/4 mx-auto bg-white rounded-lg">
            ...
            <div className="p-6 space-y-4">
                <div className="">
                    ...
                    <div className="mt-2 flex items-center gap-2 px-3 py-2.5 rounded-xl border border-gray-300 bg-gray-50 focus-within:ring focus-within:ring-primary focus-within:border-primary transition-all">
